...
FOR EACH ROW
BEGIN
    DECLARE tempo_total TIME DEFAULT '00:00:00';
    DECLARE tempo_semanal TIME DEFAULT '00:00:00';
    DECLARE classificacao_total VARCHAR(50) DEFAULT 'Iniciante';
    DECLARE classificacao_semanal VARCHAR(50) DEFAULT 'Iniciante';

    -- Calculando as horas totais
    SELECT SEC_TO_TIME(IFNULL(SUM(TIME_TO_SEC(TIMEDIFF(HORARIO_SAIDA, HORARIO_INICIO))), 0)) 
    INTO tempo_total
    FROM CATRACA
